  ...
  return (
    <div>
      ...
      >
        ...
        <br />
        <br />
        This is a Holy Spirit–led healing journey, where we move slowly and
        ...
        <br /> I gently walk alongside women through a 12-week healing journey,
        partnering with God to tend the soil of grief and begin growing forward
        again, trusting that He brings life, restoration, and hope in His
        perfect time.
      </Text>
