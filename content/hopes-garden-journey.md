...
movements:
  ...
  - title: Tending the Soil
    description: Softening the heart to receive the nutrients of grace and healing.
  - title: The Seed of Lament
    description: Finding the sacred language of grief and naming the deep questions.
  - title: Watering the Roots
    description: Nurturing the foundational truths of your identity and belovedness.
  - title: The First Sprout
    description: Witnessing the first signs of resilience emerging through the brokenness.
  - title: Pruning the Self
    description: Refining priorities and setting boundaries for the next season.
  ...
  - title: Deep Blooming
    description: Fully inhabiting your story with newfound strength and vulnerability.
  - title: Gathering the Harvest
    description: Identifying the fruit that has grown from the compost of pain.
...
pricingOptions:
  - title: THE GROUP COHORT
    features:
      ...
      - Access to full 12-week curriculum
...
faqs:
  ...
  - question: What if I don’t feel ready for deep healing work?
    answer: |-
      That’s okay. If you are in the earliest days of grief, First Light Ministry may be a better first step. The Hope’s Garden Healing Journey™ is for those who sense they are ready to begin tending the soil again, even gently.

  - question: Does this program include Immanuel Prayer?
    answer: |-
      Yes. The journey includes one primary Immanuel Prayer session with spacious integration weeks. Additional Immanuel Prayer sessions may be available by invitation following completion of the program.

  - question: What is the Wildflower Circle?
    answer: |-
      The Wildflower Circle is an ongoing community for graduates of the Hope’s Garden Healing Journey™ who desire continued connection, prayer, and support. Participation is optional.
  ...
  - question: How do I know if this is a good fit?
    answer: |-
      Start with a free Discernment Call. We’ll talk gently about what you’re walking through and discern together whether Hope’s Garden Healing Journey™ is a good next step.
